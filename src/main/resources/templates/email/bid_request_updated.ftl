            ...
            <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                ...
                <tr>
                    <td align="center" style="background:linear-gradient(135deg,#4f46e5,#7c3aed); padding:40px 24px;">
                        ...
                        <h1 style="margin:0; color:#ffffff; font-size:24px; font-weight:600;">Bid Updated</h1>
                    </td>
                </tr>
                <!-- Body -->
                <tr>
                    <td style="padding:32px 32px 8px 32px;">
                        ...
                        <p style="margin:0 0 24px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                            Your bid on &ldquo;<strong>${data.itemName}</strong>&rdquo; has been updated to
                            <strong>$${data.newBidAmount}</strong>.
                        </p>
                    </td>
                </tr>
                <!-- CTA -->
                ...
                <tr>
                    <td style="padding:0 32px 32px 32px;">
                        <p style="margin:0 0 12px 0; font-size:14px; color:#6b7280; font-weight:600;">Updated bid details:</p>
                        <p style="margin:0 0 8px 0; font-size:14px; color:#4b5563;">&#128230; Item: ${data.itemName}</p>
                        <p style="margin:0; font-size:14px; color:#4b5563;">&#128176; New bid: $${data.newBidAmount}</p>
                    </td>
                </tr>
                <!-- Footer -->
                <tr>
