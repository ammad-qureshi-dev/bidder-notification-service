            ...
            <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                ...
                <tr>
                    <td align="center" style="padding:0 32px 32px 32px;">
                        <a href="${data.verificationUrl!'#'}" style="display:inline-block; background-color:#4f46e5; color:#ffffff; text-decoration:none; font-size:15px; font-weight:600; padding:14px 32px; border-radius:8px;">
                            Verify Account
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:0 32px 32px 32px;">
                        <p style="margin:0; font-size:14px; color:#6b7280;">
                            If you didn't create a Bidder account, you can safely ignore this email.
                        </p>
                    </td>
                </tr>
                <!-- Footer -->
